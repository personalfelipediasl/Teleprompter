  ...
  return {
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          id: '/',
          name: 'Teleprompter Profissional',
          short_name: 'Teleprompter',
          description: 'Aplicativo profissional de teleprompter e estúdio de gravação de vídeo com modo flutuante, espelhamento, controle de voz e gravação.',
          theme_color: '#0f172a',
